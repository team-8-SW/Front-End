  ...
  return (
    <div className="flex flex-col items-center justify-center w-full mt-10">
      <Card className="w-[80%] p-6">
        <Typography variant="h4" className="mb-6">Applications for Your Posted Job</Typography>
                ...
                <Card key={app.id} className="p-4 shadow-sm">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <Typography variant="small" color="gray">{profile?.bio || "No bio available"}</Typography>
                      <Typography variant="small" color="gray">{profile?.location || "No location"}</Typography>
                    </div>
                  </div>
                  ...
                  <div className="mt-3">
                    ...
                    <div className="flex gap-4 mt-4">
                      <Button color="green" onClick={() => handleAccept(app.id)} disabled={app.status === "accepted"}>
                        Accept
                      </Button>
                      <Button color="red" onClick={() => handleReject(app.id)} disabled={app.status === "rejected"}>
                        Reject
                      </Button>
                      <Button color="blue" onClick={() => handleViewResume(app.applicant_id)}>
                        View Resume
                      </Button>
                    </div>
                  </div>
