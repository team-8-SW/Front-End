      ...
      {connections.length > 0 ? (
        <>
          ...
          <div className="space-y-4">
            {filteredConnections.map((connection) => (
              <div key={connection.id} className="flex items-center justify-between py-3">
                <div className="flex items-center">
                  <img 
                    src={connection.profilePicture || "/api/placeholder/60/60"} 
                    alt={connection.name} 
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs mt-1">connected on {connection.connectionDate}</p>
                  </div>
                </div>
                <div className="flex items-center">
        ...
        <div className="text-center py-12">
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <div className="relative bg-white p-4 rounded-lg border border-blue-200">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#0077B5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className="text-gray-600 mb-8 max-w-lg mx-auto">
            Discover fresh ideas and jobs on LinkedIn through your connections and their networks. Find your first connection below.
          </p>
        </div>
      )}
    </div>
